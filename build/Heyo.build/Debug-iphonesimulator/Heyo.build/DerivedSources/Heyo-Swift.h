...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Heyo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC4Heyo18MultipeerViewModel")
@interface MultipeerViewModel : NSObject
...
@interface MultipeerViewModel (SWIFT_EXTENSION(Heyo)) <MCNearbyServiceAdvertiserDelegate>
...
@interface MultipeerViewModel (SWIFT_EXTENSION(Heyo)) <MCNearbyServiceBrowserDelegate>
...
@interface MultipeerViewModel (SWIFT_EXTENSION(Heyo)) <MCSessionDelegate>
